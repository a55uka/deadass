#!/usr/bin/env bash
# Linux build helper for the deadass addon: mirrors scripts/build.ps1,
...
SRC="$PROJECT/mod/content"
ADDONINFO="$PROJECT/mod/addoninfo.txt"
