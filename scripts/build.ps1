...
$SourceRoot = Join-Path $ProjectRoot "mod\content"
$AddonInfo = Join-Path $ProjectRoot "mod\addoninfo.txt"
$BuildName = "deadass"
...
if ([string]::IsNullOrWhiteSpace($OutputPath)) {
    $OutputPath = Join-Path $ProjectRoot "dist\deadass.vpk"
...
if (Test-Path $AddonInfo -PathType Leaf) {
    Copy-Item $AddonInfo $GameBuildRoot -Force
}
